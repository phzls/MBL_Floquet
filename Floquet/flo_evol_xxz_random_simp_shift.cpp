 ...
 */
void FloEvolXXZRandomSimpShift::Repr_Init_(){
    repr_ << "XXZ_Random_Simple_Shift_Floquet_L=" << size_ << ",W=" << W_;
    type_ = "XXZ_Random_Simple_Shift_Floquet";
}

/*
 * Initialize random numbers
 */
void FloEvolXXZRandomSimpShift::Evol_Para_Init() {
 ...
 */
void FloEvolXXZRandomSimpShift::Evol_Construct() {
 ...
 */
void FloEvolXXZRandomSimpShift::Evol_X_Construct_(MatrixXcd & evol_half_x) {
 ...
 */
void FloEvolXXZRandomSimpShift::Evol_Z_Construct_(MatrixXcd & evol_z) {
    for (int i=0; i<dim_;i++){
