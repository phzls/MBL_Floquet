 ...
 */
void FloModelTransition::ZZ_corr_square_init_(AllPara const & parameters) {
 ...
 */
void FloModelTransition::ZZ_corr_square_out_(AllPara const & parameters, const string& name) {
