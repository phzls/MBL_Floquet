 ...
 ** process data once and only store one set of data. If it is used to process multiple data
 ** sets, then it must be reset in between, which loses all information about the previous
 ** data set.
 **/
...
class ResultsOutput
{
	public:
		/* 
		 * The function which processes all the data. It may call different functions
		 * specific to particular derived classes to hand different data, and different
		 * bools to control excution of calculations. 
		 */
